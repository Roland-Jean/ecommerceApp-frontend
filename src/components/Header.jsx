              ...
              <div className="absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-lg mt-1 z-50">
                {suggestions.map((suggestion) => (
                  ...
                  >
                    ...
                    <div className="ml-auto text-blue-600 font-semibold">{suggestion.price}</div>
                  </div>
                ))}
              </div>
            )}
            ...
            {showSuggestions && searchQuery.length > 2 && suggestions.length === 0 && (
              <div className="absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-lg mt-1 z-50">
                <div className="px-4 py-6 text-center">
                  ...
                  <div className="text-gray-600 mb-2">No products found for "{searchQuery}"</div>
                  <div className="text-sm text-gray-500">Try: "iPhone", "laptop", "headphones"</div>
                </div>
              </div>
            )}
          </div>
